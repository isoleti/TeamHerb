		...
		<div class="main_wrap">
			<div class="customerCenter_area">
				...
				<div class="notice_area">
					...
					<form id="view_form" action="customerFAQ_counselling.do" >
					 ...
					 <!--부트스트랩 페이지네이션-->
						...
						<!--이전버튼 활성화 -->
					              <c:if test="${pageMaker.prev}">
						              <li class="page-item">
						                <a class="page-link" href="<%=request.getContextPath() %>/customerService/customerFAQ_counselling.do?page=${(pageMaker.startPage-1)}&perPageNum=${pageMaker.perPageNum}" aria-label="Prev">
				        ...
				        <!-- Page번호 시작 -->
					           <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage}" var="index">
						         	<li class="page-item"><a class="page-link <c:if test='${pageMaker.page eq index }'>active</c:if>" href="<%=request.getContextPath() %>/customerService/customerFAQ_counselling.do?page=${index}">${index}</a></li>
						       </c:forEach>
					    <!-- Page번호 끝 -->
					    <!-- Next 시작 -->
					          <c:if test="${pageMaker.next}">
						          <li class="page-item">
							            <a class="page-link" href="<%=request.getContextPath() %>/customerService/customerFAQ_counselling.do?page=${(pageMaker.endPage+1)}&perPageNum=${pageMaker.perPageNum}" aria-label="Next">
