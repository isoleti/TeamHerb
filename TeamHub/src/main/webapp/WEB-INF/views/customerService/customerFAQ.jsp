			...
			<div class="customerCenter_area">
				...
				<div class="notice_area">
					...
					<div class="FAQ_select">
						<div class="faq_nav" id="all">전체</div><!--전체-->
						<div class="faq_nav" id="counselling">심리상담</div><!--심리상담-->
						<div class="faq_nav" id="reservation">예약결제</div><!--예약결제-->
						<div class="faq_nav" id="gita">기타</div><!--기타-->
					</div><!---->
