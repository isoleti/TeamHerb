...
<html lang="ko">
	...
	<body>
		...
		<main>
			...
			<form action="" name="submitForm" method="get" onsubmit="return false;">
				<div id="type_box" >
					<input type="hidden" name="category" value="">
<!-- 					<input type="button" class="cate active" value="전체보기" onclick="location.href='adminPage_Faq_List.do'" > -->
