     ...
     <main>
       <div id="left_nav">
        ...
        <div id="filter">
          <ul id="filter_option">
                <li>
                <button type="button" onclick="location.href='<%=request.getContextPath()%>/adminPage/adminPage_Counseller_Board_List.do?&searchType=${searchVO.searchType}&searchVal=${searchVO.searchVal}&sort=edate'">
                 	최신순
                </button>
                </li>
                <li>
                <button type="button" onclick="location.href='<%=request.getContextPath()%>/adminPage/adminPage_Counseller_Board_List.do?&searchType=${searchVO.searchType}&searchVal=${searchVO.searchVal}&sort=id'">
                 	아이디오름차순
                </button>
                </li>
                <li>
                <button type="button" onclick="location.href='<%=request.getContextPath()%>/adminPage/adminPage_Counseller_Board_List.do?&searchType=${searchVO.searchType}&searchVal=${searchVO.searchVal}&sort=title'">
                 	제목 오름차순
                </button>
                </li>
           </ul><!--e:#filter_option-->
