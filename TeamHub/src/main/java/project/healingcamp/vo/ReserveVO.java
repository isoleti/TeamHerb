...
public class ReserveVO {
	...
	private String name;
	private String grade; //학력
	private String certi1; //자격증
	private String certi2;
	private String certi3;
	private String certi4;
	private String article1; //논문 및 저서
	...
	public int getCnoidx() {
		return cnoidx;
	}
	public void setCnoidx(int cnoidx) {
		this.cnoidx = cnoidx;
	}
	...
	public String getCerti4() {
		return certi4;
	}
	public void setCerti4(String certi4) {
		this.certi4 = certi4;
	}
	...
	public int getCintidx() {
		return cintidx;
	}
	public void setCintidx(int cintidx) {
		this.cintidx = cintidx;
	}
