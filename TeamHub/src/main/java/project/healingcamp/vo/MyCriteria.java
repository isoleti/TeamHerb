...
//마이페이지 나의 글쓰기 criteria 
public class MyCriteria extends Community_BoardVO{
	   ...
	   private int rowEnd; // 페이지 내비게이션 마지막 번호 
	    ...
	    public MyCriteria(int page, int perPageNum) { // 최초 default 생성자로 기본 객체 생성시 초기값을 지정한다. (1페이지, 4개씩)
	        this.page = 1;  // 사용자가 세팅하지 않으면 기본 1
	        this.perPageNum = 7; // 페이지당 기본 4개씩 출력하도록 세팅
	    }
